...
import com.orange.util.Logging;
...
//    {
//      PyException pyErr = (PyException)t;
//      addInfo("Python type: " + pyErr.type);
//      addInfo("Python value: " + pyErr.value);
//      addInfo("Python stack: " + pyErr.traceback.dumpStack());
//    }
  }
